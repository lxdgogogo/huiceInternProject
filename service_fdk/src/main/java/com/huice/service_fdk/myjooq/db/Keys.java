...
public class Keys {
    ...
    public static final UniqueKey<SellerOnPrepareSkuListCopy1Record> KEY_SELLER_ON_PREPARE_SKU_LIST_COPY1_PRIMARY = Internal.createUniqueKey(SellerOnPrepareSkuListCopy1.SELLER_ON_PREPARE_SKU_LIST_COPY1, DSL.name("KEY_seller_on_prepare_sku_list_copy1_PRIMARY"), new TableField[] { SellerOnPrepareSkuListCopy1.SELLER_ON_PREPARE_SKU_LIST_COPY1.ID }, true);
