...
public class Indexes {
    ...
    public static final Index SELLER_ON_PREPARE_SKU_LIST_COPY1_IDX_MID_SELSKUID = Internal.createIndex(DSL.name("idx_mid_selskuid"), SellerOnPrepareSkuListCopy1.SELLER_ON_PREPARE_SKU_LIST_COPY1, new OrderField[] { SellerOnPrepareSkuListCopy1.SELLER_ON_PREPARE_SKU_LIST_COPY1.MERCHANT_ID, SellerOnPrepareSkuListCopy1.SELLER_ON_PREPARE_SKU_LIST_COPY1.SELLER_SKU_ID }, false);
